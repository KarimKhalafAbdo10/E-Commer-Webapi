namespace E_Commerce.Application.common
{
    public record Error(string Code,string description , ErrorType Type = ErrorType.Failure)
    {
        ...
        public static Error Validation(string code="General.Validaion",string description="a validation error has occurred")
            => new(code, description, ErrorType.validation);
        public static Error NotFound(string code="General.Noutfound",string description="the requsted resource was not found")
